...
\newcommand{\mysupervisor}{Dr.-Ing. Linh Kästner} %% your supervisor
...
\include{template/listofabbreviations}
\listoffigures
\listoftables
...
\input{content/1_introduction/index}
\input{content/2_relatedworks/index}
\input{content/3_fundamentals/index}
\input{content/4_conceptualdesign/index}
\input{content/5_implementation/index}
\input{content/6_evaluation/index}
\input{content/7_conclusion/conclusion}
\input{content/8_futurework/futurework}
